...
def initialize_lora(
    ...
    for i in range(0, num_samples, batch_size):
        ...
        def lora_init_hook(m, x, y, name):
            ...
            print(weight_errs > (threshold_scale * ori_weight_err), torch.isnan(weight_errs), torch.isinf(weight_errs))
            err_masks = weight_errs > (threshold_scale * ori_weight_err) | torch.isnan(weight_errs) | torch.isinf(weight_errs)
